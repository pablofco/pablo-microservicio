...
using GtMotive.Estimate.Microservice.Api.AutoMapperProfiles;
...
builder.Services.AddDbContext<HexagonalDbContext>(options =>
    options.UseSqlServer(
        builder.Configuration.GetConnectionString("HexagonalDb"),
        sqlOptions => sqlOptions.MigrationsAssembly("GtMotive.Estimate.Microservice.Infrastructure")));

builder.Services.AddAutoMapper(typeof(CustomerProfile));
builder.Services.AddAutoMapper(typeof(RentingProfile));
