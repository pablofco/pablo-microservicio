...
[assembly: SuppressMessage("Design", "CA1062:Validar argumentos de métodos públicos", Justification = "<pendiente>", Scope = "member", Target = "~M:GtMotive.Estimate.Microservice.Infrastructure.Repositories.RetingRepository.ExistsFutureRentingAsync(GtMotive.Estimate.Microservice.ApplicationCore.Models.Dtos.RentingCustomerVehicleDto,GtMotive.Estimate.Microservice.ApplicationCore.Models.Dtos.RentingDto)~System.Threading.Tasks.Task{System.Boolean}")]
